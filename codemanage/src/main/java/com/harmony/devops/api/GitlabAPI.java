package com.harmony.devops.api;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.harmony.devops.api.http.GitlabHTTPRequestor;
import com.harmony.devops.api.http.Method;
import com.harmony.devops.api.http.Query;
import com.harmony.devops.api.models.*;
...
public class GitlabAPI {
    ...
    public GitlabHTTPRequestor dispatch() {
        return new GitlabHTTPRequestor(this).authenticate(apiToken, tokenType, authMethod).method(Method.POST);
    }
    ...
    public GitlabUser updateUser(Integer targetUserId,
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabUser.class);
    }
    ...
    public void blockUser(Integer targetUserId) throws IOException {
        ...
        retrieve().method(Method.POST).to(tailUrl, Void.class);
    }
    ...
    public void deleteSSHKey(Integer targetUserId, Integer targetKeyId) throws IOException {
        ...
        retrieve().method(Method.DELETE).to(tailUrl, Void.class);
    }
    ...
    public GitlabGroup updateGroup(GitlabGroup group, GitlabUser sudoUser) throws IOException {
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabGroup.class);
    }
    ...
    public List<GitlabProject> getProjectsWithPagination(Pagination pagination) throws IOException {
        ...
        return Arrays.asList(retrieve().method(Method.GET).to(tailUrl.toString(), GitlabProject[].class));
    }
    ...
    public GitlabProject updateProject(
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabProject.class);
    }
    ...
    public void deleteProject(Serializable projectId) throws IOException {
        String tailUrl = GitlabProject.URL + "/" + sanitizeProjectId(projectId);
        retrieve().method(Method.DELETE).to(tailUrl, null);
    }
    ...
    public GitlabMergeRequest updateMergeRequest(Serializable projectId, Integer mergeRequestIid, String targetBranch,
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabMergeRequest.class);
    }
    ...
    public GitlabMergeRequest acceptMergeRequest(Serializable projectId, Integer mergeRequestIid, String mergeCommitMessage) throws IOException {
        ...
        GitlabHTTPRequestor requestor = retrieve().method(Method.PUT);
    ...
    public GitlabDiscussion resolveDiscussion(GitlabMergeRequest mergeRequest,
        ...
        String tailUrl = GitlabProject.URL + "/" + mergeRequest.getProjectId() +
                GitlabMergeRequest.URL + "/" + mergeRequest.getIid() +
                GitlabDiscussion.URL + "/" + discussionId;
        return retrieve().method(Method.PUT)
    ...
    public GitlabNote updateNote(GitlabMergeRequest mergeRequest, Integer noteId, String body) throws IOException {
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabNote.class);
    }
    ...
    public void deleteNote(GitlabMergeRequest mergeRequest, GitlabNote noteToDelete) throws IOException {
        ...
        retrieve().method(Method.DELETE).to(tailUrl, GitlabNote.class);
    }
    ...
    public void protectBranchWithDeveloperOptions(GitlabProject project, String branchName, boolean developers_can_push, boolean developers_can_merge) throws IOException {
        ...
        retrieve().method(Method.PUT).to(tailUrl + query.toString(), Void.class);
    }
    ...
    public void unprotectBranch(GitlabProject project, String branchName) throws IOException {
        ...
        retrieve().method(Method.PUT).to(tailUrl, Void.class);
    }
    ...
    public GitlabProjectHook editProjectHook(GitlabProject project, String hookId, String url) throws IOException {
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabProjectHook.class);
    }
    ...
    public GitlabProjectMember updateProjectMember(Integer projectId, Integer userId, GitlabAccessLevel accessLevel, String expiresAt) throws IOException {
        ...
        return retrieve().method(Method.PUT).to(tailUrl, GitlabProjectMember.class);
    }
    ...
    public GitlabSystemHook deleteSystemHook(Integer hookId) throws IOException {
        String tailUrl = GitlabSystemHook.URL + "/" + hookId;
        return retrieve().method(Method.DELETE).to(tailUrl, GitlabSystemHook.class);
    }
    ...
    public boolean updateEmailsOnPush(Integer projectId, String emailAddress) throws IOException {
        ...
        return retrieve().method(Method.PUT).to(tailUrl, Boolean.class);
    }
    ...
    public boolean deleteJiraService(Integer projectId) throws IOException {
        String tailUrl = GitlabProject.URL + "/" + projectId + GitlabServiceJira.URL;
        return retrieve().method(Method.DELETE).to(tailUrl, Boolean.class);
    }
    ...
    public List<GitlabRunner> getRunnersWithPagination(GitlabRunner.RunnerScope scope, Pagination pagination) throws IOException {
        ...
        tailUrl.append(query.toString());
        return Arrays.asList(retrieve().method(Method.GET).to(tailUrl.toString(), GitlabRunner[].class));
    }
