package com.harmony.devops.api.http;

import com.harmony.devops.api.AuthMethod;
import com.harmony.devops.api.GitlabAPI;
import com.harmony.devops.api.GitlabAPIException;
import com.harmony.devops.api.TokenType;
...
public class GitlabHTTPRequestor {
    ...
    private Method method = Method.GET; // Default to GET requests
    ...
    public <T> Iterator<T> asIterator(final String tailApiUrl, final Class<T> type) {
        method(Method.GET); // Ensure we only use iterators for GET requests
    ...
    private boolean hasOutput() {
        return method.equals(Method.POST) || method.equals(Method.PUT) && !data.isEmpty();
    }
