package com.harmony.devops.user.jpush.service.impl;
...
public class MsgServiceImpl implements MsgService {
    ...
    public MsgVO getMsgByThirdMsgId(String thirdMsgId) {
        return dao.get("select new com.harmony.devops.user.jpush.pojo.vo.MsgVO(p.title,p.message,p.createTime) from BaseMsgEntity p where p.thirdMsgId=?0",
                new Object[]{thirdMsgId});
    }

    @Override
    public List<MsgVO> findPersonMsgByUserNo(String userNo ,Integer page,Integer size) {
        return dao.find("select new com.harmony.devops.user.jpush.pojo.vo.MsgVO(p.title,p.message,p.createTime) from PushPersonMsgEntity p where p.userNo=?0",
    ...
    public List<MsgVO> findSysMsgByUserId() {
        return dao.find("select new com.harmony.devops.user.jpush.pojo.vo.MsgVO(p.title,p.message,p.createTime) from PushSysMsgEntity p",
                new Object[]{});
    }
}
