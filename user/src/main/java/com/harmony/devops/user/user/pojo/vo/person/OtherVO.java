...
public class OtherVO extends PeakBaseVo {
    public OtherVO() {
    }

    //展示
    public OtherVO(Long otherId, String telcheckFlag, String zhimaScore,String applyAdressState,String applyAdressCity) {
    ...
    //上传长亮
    public OtherVO(String zhimaScore,String applyAdressState,String applyAdressCity) {
        this.telcheckFlag = telcheckFlag;
        this.zhimaScore = zhimaScore;
        this.applyAdressCity=applyAdressCity;
        this.applyAdressState=applyAdressState;
    ...
    @ApiModelProperty(value="其他信息id",name="otherId")
    ...
    @ApiModelProperty(value="产品市场ID",name="marketProductId")
    ...
    @ApiModelProperty(value="申请地址（省code)",name="applyAdressState")
    private String applyAdressState;
    @ApiModelProperty(value="申请地址（市code）",name="applyAdressCity")
