...
public class BankCardServiceImpl implements BankCardService {
    ...
    public List<CardVO> getBankCardByUserId(long userId) {
        return dao.find("select new com.harmony.devops.user.user.pojo.vo.CardVO(b.id,b.cardNo,b.user.phone,b.bankName,b.isDefault,b.isRepayDefault) from " +
    ...
    public List<BindCardTradeVO> getBindCardTrade(String consumerRealName, String phone, String idnum, String cardNo, String requestno,
        ...
        StringBuffer hql = new StringBuffer("select new com.harmony.devops.user.user.pojo.vo.BindCardTradeVO(b.requestno,b.consumerUser.personal.name,b" +
