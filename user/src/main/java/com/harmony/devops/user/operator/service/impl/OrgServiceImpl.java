...
public class OrgServiceImpl implements OrgService {
    ...
    public List<OrganizaVO> getOrganizaList(FetchOrganizaVO fetchOrganizaVO, Integer page, Integer size) {
        StringBuffer hql = new StringBuffer("select new com.harmony.devops.user.operator.pojo.vo.OrganizaVO(o.id,o.name,o.principal,o.phone,o.descript,o" +
                ".type,o" +
    ...
    public OrganizaVO getOrganizaById(long orgId) {
        return dao.get("select new com.harmony.devops.user.operator.pojo.vo.OrganizaVO(o.id,o.name,o.principal,o.phone,o.descript,o.type,o" +
    ...
    public List<OrganizaVO> getOrganizaSelectList() {
        return dao.find("select new com.harmony.devops.user.operator.pojo.vo.OrganizaVO(o.id,o.name) from OrganizationEntity o where o.isDeleted=false and " +
