package com.harmony.devops.user.operator.service.impl;
...
public class StoreServiceImpl implements StoreService {
    ...
    public List<StoreVO> getStoreList(FetchStoreVO fetchStoreVO, Integer page, Integer size) {
        StringBuffer hql = new StringBuffer("select new com.harmony.devops.user.operator.pojo.vo.StoreVO(o.id,o.storeName,o.telephone,o.contactName,o" +
    ...
    public StoreVO getStoreById(long storeId) {
        return dao.get("select new com.harmony.devops.user.operator.pojo.vo.StoreVO(o.id,o.storeName,o.telephone,o.contactName,o.address,o" +
    ...
    public List<StoreVO> getStoreByOrgId(long orgId, Integer page, Integer size) {
        return dao.find("select new com.harmony.devops.user.operator.pojo.vo.StoreVO(o.id,o.storeName,o.telephone,o.contactName,o.address,o" +
    ...
    public List<StoreVO> getStoreSelectList(long orgId) {
        return dao.find("select new com.harmony.devops.user.operator.pojo.vo.StoreVO(o.id,o.storeName) from StoreEntity o where o.isDeleted=false and o" +
