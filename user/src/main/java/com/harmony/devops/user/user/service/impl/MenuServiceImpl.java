...
public class MenuServiceImpl implements MenuService {
    ...
    public List<MenuVO> queryAllMenu() {
        List<MenuVO> menuVOS = dao.find("select new com.harmony.devops.user.user.pojo.vo.role.MenuVO(m.id,m.name,m.path,m.title,cm.id,cm.name,cm.path,cm" +
    ...
    public List<MenuPermissionVO> queryAllChildMenuPermission() {
        return dao.find("select new com.harmony.devops.user.user.pojo.vo.role.MenuPermissionVO(mp.menu.id ,mp.menu.name,mp.permission.id,mp.permission" +
    ...
    public List<MenuPermissionVO> queryChildMenuPermission(long menuId) {
        return dao.find("select new com.harmony.devops.user.user.pojo.vo.role.MenuPermissionVO(mp.permission.id,mp.permission" +
    ...
    public List<MenuVO> queryParentMenu() {
        return dao.find("select new com.harmony.devops.user.user.pojo.vo.role.MenuVO(m.id,m.name,m.path,m.title) from MenuEntity m " +
