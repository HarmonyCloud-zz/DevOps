...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static final SimpleDateFormat TIMETDATEFORMAT = new SimpleDateFormat("yyyyMMddHHmmss");
	 ...
	 * YYYYMMDDHHMMSS 当前日期
	 */
	public static String getReqDate_YYYYMMDDHHMMSS(){
		return TIMETDATEFORMAT.format(new Date());
	}

	/**
	 * YYYYMMDDHHMMSS 传入日期
	 */
	public static String getReqDate_YYYYMMDDHHMMSS(Date date){
		return TIMETDATEFORMAT.format(date);
	}
