...
public class BackUserServiceImpl implements BackUserService {
    ...
    public BackUserVO getBackUserByUserId(long userId) {
        return dao.get("select new com.zhengtou.cf.user.pojo.vo.BackUserVO(b.id,b.userNo,b.createTime,b.nickName,b.phone,b.userType,b.organiza" +
    ...
    public BackUserVO getBackUserByLoginNameAndPwd(String loginName, String passwd) {
        return dao.get("select new com.zhengtou.cf.user.pojo.vo.BackUserVO(b.id,b.userNo,b.createTime,b.nickName,b.phone,b.userType,b.organiza.id,b" +
    ...
    public List<BackUserVO> getBackUserList(BackUserReciveVO backUserReciveVO, Integer page, Integer size) {
        StringBuffer hql = new StringBuffer("select new com.zhengtou.cf.user.pojo.vo.BackUserVO(b.id,b.userNo,b.createTime,b.nickName,b.phone,b" +
