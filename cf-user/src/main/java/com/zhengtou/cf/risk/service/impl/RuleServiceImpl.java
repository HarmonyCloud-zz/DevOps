...
public class RuleServiceImpl implements RuleService {
    ...
    public List<RuleVO> getRuleList(RuleVO ruleVO, Integer page, Integer rows) {
        StringBuffer hql = new StringBuffer("select new com.zhengtou.cf.risk.pojo.vo.rule.RuleVO(r.outRuleId,r.ruleName,r.approvalCompany,r" +
    ...
    public List<RuleVO> getRuleList() {
        return dao.get("select new com.zhengtou.cf.risk.pojo.vo.rule.RuleVO(r.outRuleId,r.ruleType) from RuleEntity r where r.isDeleted=false and r" +
